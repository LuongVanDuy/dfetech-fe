...
import { CarIcon } from "@/components/client/icons/CarIcon";
      ...
      >
        <Container>
          <div className="flex flex-col items-start justify-center mb-[40px]">
            ...
            <h2 className="text-[40px] leading-[48px]">To change the world and make it a better place</h2>
          </div>

          <div className="flex flex-col gap-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {newsData1.map((news, index) => (
                <BoxNormal key={index} {...news} className="rounded-[24px] border-[1px] border-[#FFFFFF0D]" type="rounded" />
              ))}
            </div>
