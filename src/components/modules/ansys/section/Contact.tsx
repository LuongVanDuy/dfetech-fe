...
import { DropDownIcon } from "@/components/client/icons/DropDownIcon";
...
const Contact = (props: any) => {
  return (
    <section className="touch-section  min-h-[600px] lg:px-[120px]" id="contact">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="md:px-[64px] py-[36px] px-[16px] md:py-[80px] md:pb-[64px] mb-[20px]  text-start">
          <MainTitle title="Get in touch with us" description="Drop us a note - we look forward to hearing from you" className="md:pt-8" />
