...
import BoxDifferent from "@/components/client/box/BoxDifferent";
          ...
          <Container>
            <div className="flex flex-col gap-5 px-[16px] md:px-[64px] py-[36px] md:py-[80px] md:pb-[64px]">
              ...
              <p className="text-[#ADB5BD]">
                We not only implement cutting-edge engineering solutions but also make significant investments in developing and training a team of
                highly skilled experts. At DFETECH, WE ALWAYS PUT OUR CLIENTS FIRST. With the goal of bringing our clients' projects to life, we
                consistently provide the most advanced and optimized technological solutions. We are committed to supporting our clients throughout
                the entire process, delivering products and services that not only meet but exceed their expectations.
              </p>
            </div>
