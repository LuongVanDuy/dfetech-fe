...
import { FavoriteChartIcon } from "@/components/client/icons/FavoriteChart";
import { EyeIcon } from "@/components/client/icons/EyeIcon";
import { StarIcon } from "@/components/client/icons/StarIcon";
import BoxShadow from "@/components/client/box/BoxShadow";
            ...
            <div className="grid grid-cols-2 gap-10  text-white mx-16">
              ...
              <div className="h-full">
                <BoxShadow
                  title="Vision"
                  icon={<EyeIcon />}
                  description={["To become a global leader in providing simulation engineering services across a wide range of industries."]}
                />
              </div>
              <div className="h-full">
                <BoxShadow
